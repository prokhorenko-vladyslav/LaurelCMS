    ...
    <div class="main-menu">
        <vue-custom-scrollbar class="main-menu__content" tagname="div" :settings="scrollbarSettings">
            ...
            <div class="main-menu__section">
                ...
                <router-link :to="{ name : 'admin.pages.browse' }" class="main-menu__section__item"><img src="/admin/img/icons/menu/page.svg" alt=""> Pages</router-link>
            ...
            .main-menu__section__item {
                ...
                .counter {
                    ...
                    &.info {
                        ...
                        background: #E2ECFF;
                        color: #5A8DEE;
                        box-shadow: 0 4px 12px 0 rgba(90,141,238,.3);
            ...
            .has-subsection {
                ...
                .main-menu__section__item {
                    ...
                    &.toggle_checkbox {
                        ...
                        &:checked + .parent + .main-menu__subsection {
                            height: 100%;
                            max-height: 100vh;
                            transform: scaleY(1);
                            transition:
                ...
                .main-menu__subsection {
                    ...
                    .main-menu__section__subitem {
                        ...
                        &:before {
                            content: '';
                            background-image: url("/admin/img/icons/right-arrow.svg");
